...
files = [
  '../../_plots/TB/dist_hop.png',
  '../../_plots/TB/RedTB_Bands/CsPbBr3_RedTB_bands.png',
  
  '../../_plots/TB/HeatTBRed/CsPbBr3.png',
  '../../_plots/TB/HoppingParamDist.png']

saveto = '../../_plots/TB/GridReduced.png'
